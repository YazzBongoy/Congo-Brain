...
- ia_gov/: IAGov microservices and CLI helpers
- docs/iagov/: consolidated IAGov design and architecture documents

Quick start (developer):
- Create a Python 3.10+ virtual environment and install dependencies: pip install -r requirements.txt
- Run core service (if available): python -m congo_brain
- Run IAGov service (if available): python -m ia_gov
