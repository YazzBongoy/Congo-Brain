...
DRC_RESOURCES_BASELINE: list[dict] = [
    {
        "resource": "Cuivre",
        "extraction_value": 12.0,
        "transformation_value": 1.5,
        "export_value": 8.0,
        "local_processing_pct": 10.0,
        "jobs_created": 45000,
        "environmental_cost": 2.0,
    },
    {
        "resource": "Cobalt",
        "extraction_value": 6.5,
        "transformation_value": 0.3,
        "export_value": 5.0,
        "local_processing_pct": 5.0,
        "jobs_created": 20000,
        "environmental_cost": 1.5,
    },
    {
        "resource": "Or",
        "extraction_value": 3.0,
        "transformation_value": 0.2,
        "export_value": 2.5,
        "local_processing_pct": 8.0,
        "jobs_created": 15000,
        "environmental_cost": 0.8,
    },
    {
        "resource": "Coltan",
        "extraction_value": 1.5,
        "transformation_value": 0.1,
        "export_value": 1.2,
        "local_processing_pct": 3.0,
        "jobs_created": 8000,
        "environmental_cost": 0.5,
    },
    {
        "resource": "Lithium",
        "extraction_value": 2.0,
        "transformation_value": 0.05,
        "export_value": 1.8,
        "local_processing_pct": 2.0,
        "jobs_created": 5000,
        "environmental_cost": 0.3,
    },
    {
        "resource": "Pétrole",
        "extraction_value": 4.0,
        "transformation_value": 0.8,
        "export_value": 3.0,
        "local_processing_pct": 20.0,
        "jobs_created": 12000,
        "environmental_cost": 1.0,
    },
    {
        "resource": "Forêt",
...
class ResourceOptimizer:
    ...
    def get_optimization_recommendations(self) -> list[dict]:
        ...
        recommendations.sort(key=lambda x: cast(float, x["potential_additional_value"]), reverse=True)
