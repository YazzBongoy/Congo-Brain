...
class SNNOptimizationEngine:
    ...
    def load_drc_baseline(self) -> None:
        ...
        self.indicators = [
            ...
            {"name": "PIB nominal 2026", "category": "macro", "value": 49782, "target": 55000,
             "unit": "Mrd FC", "year": 2026, "source": "FMI Article IV mai 2026"},
            {"name": "Croissance PIB 2026", "category": "macro", "value": 6.4, "target": 8.0,
             "unit": "%", "year": 2026, "source": "FMI Article IV mai 2026"},
            {"name": "Inflation 2026", "category": "macro", "value": 13.9, "target": 8.0,
             "unit": "%", "year": 2026, "source": "FMI Article IV mai 2026"},
            {"name": "Budget total 2026", "category": "budget", "value": 59021, "target": 59021,
             "unit": "Mrd FC", "year": 2026, "source": "Ministère du Budget — PLF 2026"},
            {"name": "Recettes totales 2026", "category": "budget", "value": 26593, "target": 27088,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Recettes intérieures 2026", "category": "budget", "value": 22989, "target": 25000,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Dépenses totales 2026", "category": "budget", "value": 27088, "target": 27088,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Dépenses courantes 2026", "category": "budget", "value": 16592, "target": 16592,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Dépenses investissement 2026", "category": "budget", "value": 10495, "target": 10495,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Dépenses salaires 2026", "category": "budget", "value": 6994, "target": 6994,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Dépenses biens et services 2026", "category": "budget", "value": 2749, "target": 2749,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Dépenses transferts 2026", "category": "budget", "value": 6849, "target": 6849,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Dépenses intérêts dette 2026", "category": "budget", "value": 200, "target": 200,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Déficit budgétaire 2026", "category": "budget", "value": 495, "target": 0,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Déficit % PIB 2026", "category": "macro", "value": 0.99, "target": 0.0,
             "unit": "%", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Recettes entreprises publiques 2026", "category": "budget", "value": 4400, "target": 5000,
             "unit": "Mrd FC", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Part salaires/budget", "category": "budget", "value": 25.8, "target": 20.0,
             "unit": "%", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Part investissements/budget", "category": "budget", "value": 38.7, "target": 45.0,
             "unit": "%", "year": 2026, "source": "PLF 2026 — Doc 2"},
            {"name": "Taux imposition minière", "category": "fiscal", "value": 60, "target": 60,
             "unit": "%", "year": 2026, "source": "ITIE-RDC / Loi minière"},
            {"name": "IRPP taux max", "category": "fiscal", "value": 30, "target": 30,
             "unit": "%", "year": 2026, "source": "DGI — Code des impôts"},
            {"name": "TVA", "category": "fiscal", "value": 16, "target": 16,
             "unit": "%", "year": 2026, "source": "DGI — Code des impôts"},
        ]
