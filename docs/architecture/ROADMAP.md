...
## Workstream 2 — Socle Release (EN VALIDATION)
...
- [x] Runbook et scripts fail-closed backup/restore PostgreSQL
- [x] CI bloquante : imports, mypy ciblé, audits de dépendances, images API + frontend
- [ ] CI distante verte sur la PR Workstream 2
- [ ] Restauration staging documentée avec RPO/RTO observés et validation à deux personnes
